...
class DashboardBlock(models.Model):
    ...
    def get_default_action(self):
        action_id = self.env.ref('dynamic_odoo_dashboard.action_dynamic_dashboard')
        if action_id:
            return action_id.id
        else:
            return False
    ...
    x_pos = fields.Integer(string="X-Position")
    y_pos = fields.Integer(string="X-Position")
                ...
                if rec.type == 'graph':
                    ...
                    for record in records:
                        if record.get('name') and type(
                            ...
                            x_axis.append(record.get('name')[lang])
                        else:
